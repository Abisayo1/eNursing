...
import com.abisayo.computerize1.databinding.ActivityAlgorithmBinding
import com.abisayo.computerize1.databinding.ActivityAlgorithmTypesBinding
import com.google.android.material.navigation.NavigationView

class AlgorithmTypesActivity : AppCompatActivity() {
    private lateinit var binding: ActivityAlgorithmTypesBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAlgorithmTypesBinding.inflate(layoutInflater)
        ...
        binding.button.setOnClickListener {
            val i = Intent(this, AlgorithmCharactActivity::class.java)
            startActivity(i)
        }
