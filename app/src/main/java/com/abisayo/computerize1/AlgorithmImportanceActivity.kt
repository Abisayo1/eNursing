...
class AlgorithmImportanceActivity : AppCompatActivity() {
    private lateinit var binding: ActivityAlgorithmImportanceBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAlgorithmImportanceBinding.inflate(layoutInflater)
        ...
        binding.button.setOnClickListener {
            val i = Intent(this, AlgorithmStepsActivity::class.java)
            startActivity(i)
        }
        ...
        navView.setNavigationItemSelectedListener {
            ...
            when (it.itemId) {
                ...
                R.id.algo_need -> scrollToView(binding.scroll, binding.algoNeed)
