...
import com.abisayo.computerize1.databinding.ActivityCommunicationFlashcardBinding
import com.google.android.material.navigation.NavigationView

class CommunicationFlashcardActivity : AppCompatActivity() {
    
    private lateinit var binding: ActivityCommunicationFlashcardBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCommunicationFlashcardBinding.inflate(layoutInflater)
        ...
        navView.setNavigationItemSelectedListener {
            ...
            when (it.itemId) {
                ...
                R.id.introduction -> {
                    this.startCommunicationFlashcardActivity(Flashcards.communicationIntroFlashcard())
                }
                R.id.example -> {
                    this.startCommunicationFlashcardActivity(Flashcards.communicationExamplesFlashcard())
                }
                R.id.improve -> {
                    this.startCommunicationFlashcardActivity(Flashcards.communicationImproveFlashcard())
                }
                R.id.workspace -> {
                    this.startCommunicationFlashcardActivity(Flashcards.communicationWorkspaceFlashcard())
                }
