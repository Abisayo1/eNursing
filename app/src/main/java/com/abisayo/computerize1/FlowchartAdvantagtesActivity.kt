...
import com.abisayo.computerize1.databinding.ActivityFlowchartAdvantagtesBinding
import com.abisayo.computerize1.databinding.ActivityFlowchartRulesBinding
import com.google.android.material.navigation.NavigationView


class FlowchartAdvantagtesActivity : AppCompatActivity() {
    private lateinit var binding: ActivityFlowchartAdvantagtesBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityFlowchartAdvantagtesBinding.inflate(layoutInflater)
        setContentView(binding.root)

        binding.button.setOnClickListener {
            val intent = Intent(this, FlowchartDisadvantagesActivity::class.java)
