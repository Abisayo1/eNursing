...
import com.abisayo.computerize1.databinding.ActivityAlgorithmImportanceBinding
import com.abisayo.computerize1.databinding.ActivityAlgorithmStepsBinding
import com.google.android.material.navigation.NavigationView

class AlgorithmStepsActivity : AppCompatActivity() {
    private lateinit var binding: ActivityAlgorithmStepsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAlgorithmStepsBinding.inflate(layoutInflater)
        ...
        binding.button.setOnClickListener {
            val i = Intent(this, AlgorithmExamplesActivity::class.java)
            startActivity(i)
        }
        ...
        navView.setNavigationItemSelectedListener {
            ...
            when (it.itemId) {
                ...
                R.id.algo_charact -> {intent = Intent(this, AlgorithmStepsActivity::class.java)
                    startActivity(intent)
                }
