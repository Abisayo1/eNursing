...
class AlgorithmCharactActivity : AppCompatActivity() {
    private lateinit var binding: ActivityAlgorithmCharactBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAlgorithmCharactBinding.inflate(layoutInflater)
        ...
        binding.button.setOnClickListener {
            val i = Intent(this, AlgorithmImportanceActivity::class.java)
            startActivity(i)
        }
